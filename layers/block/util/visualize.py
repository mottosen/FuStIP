...
def _build_row(label, df):
    ...
    return {
        ...
        "plots": [
            ...
            lambda ax, d=df, t=types: plot_inflight_over_time(ax, d, "insert", "issue", "op", "timestamp_ns", t, title="Queue Inflight"),
            lambda ax, d=df, t=types: plot_inflight_over_time(ax, d, "issue", "complete", "op", "timestamp_ns", t, title="Driver Inflight"),
...
def main():
    ...
    build_dashboard(
        rows=rows,
        col_titles=["Type Distribution", "Queue Inflight", "Driver Inflight", "Cumul. MB", "IO Size CDF", "Latency CDF"],
